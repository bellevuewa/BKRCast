...
if int(input_config.model_year) >= 2044:
    HOT_rate_dict = {'am' : {1: 15, 2: 60, 3: 15, 4: 60, 6: 35},
                  'md' : {1: 15, 2: 15, 3: 15, 4: 15, 6: 10},
                  'pm' : {1: 60, 2: 15, 3: 60, 4: 15, 6: 35},
...
max_num_iteration_for_emme_assignment = 100   # Assignment Convergence Criteria
...
transit_node_constants = {'am': {
                          ...
                          'M00B': {'@hdwfr': '.5', '@wait' : '2', '@invt' : '1', '@addfare' : '0'},
...
transit_line_for_od_list = ['M271', 'S550', 'Link_Line_2', 'M00B', 'M241', 'M250']
