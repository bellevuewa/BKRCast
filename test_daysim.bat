...
python scripts/summarize/standard/tour_mode_share_calculator.py -s "F:\projects\2024baseyear\BKR4-24-v1\inputs\subarea_definition\BKR_only_TAZ.txt"
...
python scripts/summarize/standard/trip_mode_share_calculator.py -s "F:\projects\2024baseyear\BKR4-24-v1\inputs\subarea_definition\BKR_only_TAZ.txt"
