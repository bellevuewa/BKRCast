...
if(prepSurvey)
{
  ...
  survtripdata <- prep_tripdata(survtripdata,survtourdata,survperdata,"survey")
  write_tables(tripmodemodelout,survtripdata,tripmodemodelfile,"survey")
...
if(prepDaySim)
{
  ...
  dstripdata <- prep_tripdata(dstripdata,dstourdata,dsperdata,"daysim")
  write_tables(tripmodemodelout,dstripdata,tripmodemodelfile,"daysim")
