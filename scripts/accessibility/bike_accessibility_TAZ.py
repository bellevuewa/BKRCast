...
# use weighted bike surface area within buffer to as bike accessibility
def calculate_TAZ_accessibility_to_bike(taz_gdf, emme_link_gdf, biketype = [10, 1, 2], buffer_dist = 5280):
    '''
