...
def run_importer(project_name, delete_all_scenarios = True):
    ...
    for key, value in sound_cast_net_dict.items():
        ...
        # calculate signal delay for bike and store in @bsigdelay (link extra attribute)
        # @bsigdelay is created if it does not exist or overwritten otherwise.
...
if __name__ == "__main__":
    ...
    logger, start_time = open_main_logger(meta_data, 'Network Importer')
