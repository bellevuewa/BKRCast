...
def runPopSampler():
    ...
    tazSampleRateFileName = os.path.join(os.getcwd(), tazSampleRateFileName)
    sampleRates = pd.read_table(tazSampleRateFileName)

    popsynFileName = "hh_and_persons.h5"
    popsynFileName = os.path.join(os.getcwd(), popsynFileName)
    ...
    new_households['hhno'] = new_households['hhno_new']
    new_persons['hhno'] = new_persons['hhno_new']
    ...
    popsynOutFileName = os.path.join(os.getcwd(), popsynOutFileName)
